import { GERSTEWEINCONTRACT, USDCONTRACT} from "./stores"
...
export const addGersteToken = () => {
    ...
    params: {
      ...
      options: {
        address: GERSTEWEINCONTRACT, // The address that the token is at.
        symbol: "GWT", // A ticker symbol or shorthand, up to 5 chars.
...
export const addUSDCtToken = () => {
    ...
    params: {
        type: 'ERC20', // Initially only supports ERC20, but eventually more!
        options: {
        address: USDCONTRACT, // The address that the token is at.
        symbol: "USDCtesr", // A ticker symbol or shorthand, up to 5 chars.
        decimals: "6", // The number of decimals in the token
        }}})
    } catch (err) {
    console.log("error!")
